...
<div class="overlay" id="overlay">
    <div class="popup" id="popup">
      ...
      <div class="compimg"><img src="data:image/jpg;base64,
                ...
                <div>
                  <p id="p2">Ayudanos a compartir con tus contactos este artículo</p>
                </div>

                 
                  <a href="https://api.whatsapp.com/send?text=http://localhost/adop/blog/plantillablog1.php?id=<?php echo($fila['id']);?>" target="blank" ><i class="fab fa-whatsapp"></i></a>
                  <p>whatsapp</p>
                </div>
