                   ...
                   <center><div class="col">
                    ...
                    <div class="col">
                        ...
                        <div class="textdetanimal">
                            ...
                            <h2 class="animal" ><?php echo $fila['titulo'];?></h2>
                            <p  class="animal"><?php echo $fila['subtitle1'];?></p>
                            <p><?php echo $fila['parrafo1'];?></p>
                            
                            <p class="animal"><?php echo $fila['subtitle2'];?></p>
                            <p><?php echo $fila['parrafo2'];?></p>
