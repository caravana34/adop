...
<head>
    ...
    <link rel="stylesheet" href="./FormRegistroadmin.css">
         ...
         <img src="./../img/brand1-01.svg" alt="Logo Mimascota" class="nav-brand"></a> 
            ...
            <div>
                <form class="regis" action="insertar.php" method="POST" enctype="multipart/form-data">
                    ...
                    Contraseña <br><input class="place"  type="password" name="contrasena" size="30" maxlength="50" placeholder="Contraseña"> <br><br>
                    Estado <br><input class="place"  type="text" name="estado" size="30" maxlength="50" placeholder="Descripción"> <br><br>
                    IdTipoUsuario <br><input class="place" type="number" name="idTipoUsuario" size="30" maxlength="50" placeholder="id Asignado"> <br><br>
